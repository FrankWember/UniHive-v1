...
export const ServicesHeader = () => {
  ...
  if (isMobile) {
    return (
      <div className="flex items-center justify-between h-16 w-full py-2 px-6 fixed top-0 backdrop-blur-sm z-50 bg-background/100">
        <SearchBar />
      </div>
    )
  }
  return (
    <div className="flex items-center justify-between h-16 w-full border-b py-2 px-6 fixed top-0 backdrop-blur-sm z-50 bg-background/100">
        <div className="flex justify-start items-center gap-3">
            ...
            <p className="text-lg font-medium text-muted-foreground">Any Skill Pays the Bill</p>
        </div>
