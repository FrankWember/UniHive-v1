    ...
    <div className='grid grid-cols-1 md:grid-cols-2 w-full gap-16 py-8'>
      <div className='flex flex-col gap-6'>
        <div className="grid grid-cols-5 gap-4">
          <div className="col-span-2 flex items-center justify-center space-x-2 md:space-x-4 w-full">
            <h2 className="text-6xl md:text-8xl font-bold text-center">
              {averageRating || 0}
            </h2>
            <Star className="text-yellow-500 fill-yellow-500 h-16 w-16 md:h-20 md:w-20" />
          </div>
        ...
        <div className='grid grid-cols-2 md:grid-cols-1 space-y-3 space-x-1 text-sm md:text-base'>
